      ...
      <div className="container relative z-10 mx-auto px-4 py-20 md:py-32 lg:py-40">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              size="lg"
              className="bg-white text-black hover:bg-white/90 font-semibold text-lg px-8 py-6 h-auto shadow-xl hover:shadow-2xl transition-all duration-300 group"
            >
              Open Account
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-3xl mx-auto">
            <div className="bg-background/50 backdrop-blur-sm border border-border rounded-lg p-4 md:p-6">
